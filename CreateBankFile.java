...
public class CreateBankFile
{
	public static void main(String[] args)
	{
		...
		final String ACCOUNTNUM_FORMAT = "0000";
		final String NAME_FORMAT = "        ";
		final int NAME_LENGTH = NAME_FORMAT.length();
		final String BALANCE_FORMAT = "00000.00";
		final String delimiter = ",";

		String defaultRec = ACCOUNTNUM_FORMAT + delimiter + NAME_FORMAT + delimiter + BALANCE_FORMAT + System.getProperty("line.separator");
		final int RECORD_SIZE = defaultRec.length();
		...
		createEmptyFile(file, defaultRec, NUMBER_OF_RECORDS);
